...
import com.template.myapplication.utils.BitmapUtil;
import com.template.myapplication.utils.ZxingQrCodeUtil;
    ...
    private void initView() {
        ...
        imageView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                //  显示dialog
                View customView = LayoutInflater.from(MainActivity.this).inflate(R.layout.dialog_long_img, null);
                ...
                saveImg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean b = BitmapUtil.getInstance().saveImageToGallery(MainActivity.this, bitmap);
                        if (b){
                ...
                discernImg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(MainActivity.this,"QrCode:"+result.getText(), Toast.LENGTH_LONG).show();
                        popupWindow.dismiss();
                    }
                });
